...
--  } uart_hw_flowcontrol_t;
   type Hw_Flow_Control_T is (
                              Hw_Flowctrl_Disable, -- 0x0, disable hardware flow control
                              Hw_Flowctrl_Rts,     -- 0x1, enable RX hardware flow control (rts)
                              Hw_Flowctrl_Cts,     -- 0x2, enable TX hardware flow control (cts)
                              Hw_Flowctrl_Cts_Rts, -- 0x3, enable hardware flow control
                              Hw_Flowctrl_Max      -- 0x4,
                             );
--  --*
...
--  #endif
--  } uart_sclk_t;
   type Source_Clock_T is (
                           Sclk_Apb,      -- 0x0 source clock from APB
                           Sclk_Rtc,      -- 0x1 source clock from RTC
                           Sclk_Xtal,     -- 0x2 source clock from XTAL
                           Sclk_Ref_Tick  -- 0x3 source clock from REF_TICK
                          );
--  --*
